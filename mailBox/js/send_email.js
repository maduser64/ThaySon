...
console.log("read");
	...
	$("#to_manuals").tokenInput("emailLookup.php?q=", {
		...
		resultsFormatter: function(item) {
			return "<li><div style=\'display: inline-block; padding-left: 10px;\'><div class=\'email_row\'>" + item.first_name +" &lt;" + item.last_name + "&gt;" + "</div></div></li>";
		},
	...
	$("#cc_manuals").tokenInput("emailLookup_1.php?q=", {
		theme: "facebook",
		tokenValue: "name", 
		resultsFormatter: function(item) {
	...
	$("#search_user").tokenInput("emailLookup_2.php?q=", {
		theme: "facebook",
		tokenValue: "name", 
		resultsFormatter: function(item) {
			return "<li><div style=\'display: inline-block; padding-left: 10px;\'><div class=\'email_row\'>" + item.first_name + " " + item.last_name + " &lt;" + item.name + "&gt;" + "</div></div></li>";
