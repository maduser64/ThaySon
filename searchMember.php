...
<!--                                    <h2 class=" center">Update Personal info</h2>-->
                                    ...
                                    <form class="form-horizontal" role="form" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input name="phone" class="form-control" value="<?php echo $res->getPhoneNumber() ?>" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input class="form-control" value="<?php echo $res->getAddress() ?>" type="text" name="address">
                                            </div>
                                        </div>
                                        <div class="form-group">
