...
class MembersSearchUserGroup {
    ...
    private $IdGroupFacebook;
            
    function getIdUserManager() {
        return $this->idUserManager;
    }

    function getUsernameManager() {
        return $this->usernameManager;
    }

    function getFullnameManager() {
        return $this->fullnameManager;
    }

    function getPhoneNumberManager() {
        return $this->phoneNumberManager;
    }

    function getIdGroupFacebook() {
        return $this->IdGroupFacebook;
    }

    function setIdUserManager($idUserManager) {
        $this->idUserManager = $idUserManager;
    }

    function setUsernameManager($usernameManager) {
        $this->usernameManager = $usernameManager;
    }

    function setFullnameManager($fullnameManager) {
        $this->fullnameManager = $fullnameManager;
    }

    function setPhoneNumberManager($phoneNumberManager) {
        $this->phoneNumberManager = $phoneNumberManager;
    }

    function setIdGroupFacebook($IdGroupFacebook) {
        $this->IdGroupFacebook = $IdGroupFacebook;
    }
